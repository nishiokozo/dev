			...
			if ( g_buf_land[ g_reso_x*y+x ] == 0 )
			{
				if ( flgSymmetry ) 
				{
					...
					else
					{
						...
						g_bufA[ g_reso_x*y+w ] = g_penCol*1;
					}
				}
				else
				{
					if ( flgBold )
					{
						g_bufA[ round2d(x  ,y  ,g_reso_x,g_reso_y)	] = g_penCol*1;
						g_bufA[ round2d(x  ,y+1,g_reso_x,g_reso_y)	] = g_penCol*1;
						g_bufA[ round2d(x-1,y  ,g_reso_x,g_reso_y)	] = g_penCol*1;
						g_bufA[ round2d(x-1,y+1,g_reso_x,g_reso_y)	] = g_penCol*1;
					}
					else
					{
						g_bufA[ g_reso_x*y+x ] = g_penCol*1;
					}
				}
				update_paint();
			}
