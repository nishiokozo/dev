...
//--------------------------------------------------------------------------
{
	...
	while(len)
	{
		document.getElementById("src").value += (cnt).toHex(4)+" ";
		var x=16;
		while(x&&len)
		{
			var v=mem[cnt];
			document.getElementById("src").value += (v*1).toHex(2)+" ";
			x--;
			len--;
			cnt++;
		}
...
dumpHex( g_memory, 0x40 );	
//		document.getElementById("src").value ="; Z80 smaple\n";
//		document.getElementById("dst").value ="; Z80 smaple\n";

for ( let i = 0 ; i < 256 ; i++)
{
//	console.log( Number.toBin(i) );
	let bin = ("00000000"+i.toString(2)).slice(-8);
	document.getElementById("src").value += i.toHex(2) +" " + bin.substr(0,2) +" " + bin.substr(2,3) +" " + bin.substr(5,3)+"\n";

}
// 00*  00_fff_000	JR	ff,e
//01rrrppp
//00rrr110
//01rrr100
//01rrr110
...
// 32	00_110_010
// 2A	00_101_010
// 40*	01_rrr_000	IN	r,(C)
// 41*	01_rrr_001	OUT	A,(n)
// 3A	01_111_010
// 36	01_110_110
// C0*	11_ccc_000	RET	cc
// C2*	11_ccc_010	JR	cc,nn
// CB	11_001_011
// C4*	11_ccc_100	CALL nn
// DD	11_011_101
// FD	11_111_101
// ED	11_101_101

console.log( 0b1110_1110 );
