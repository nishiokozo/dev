...
let gra = g_context.createImageData( 640, 200*scale );
...
//	    + " button  :" + e.button   + "\n" 
	...
	if ( e.buttons==1 )
	{
		circle( g_context, e.offsetX, e.offsetY,8);
	}
	{
		let x = e.offsetX;
		let y = e.offsetY;
		let cols = g_context.getImageData(x, y, 1, 1);
...
const	GC = 0x00ff88;
const	WR = 0xff8888;
const	WWY = 0xfff8bb;		//0xffeecc;	//0xffffaa
const	WYYY = 0xfff0aa;	//0xffddbb;	//0xffff40;
const	WRRR = 0xff7777;
...
/* 330*/284,6,300,4,313,3,324,3,358,4,381,7,400,12,408,15,421,22,435,32,448,45,457,56,466,71,472,83,475,96,477,107,476,117,473,126,469,132,0,0,
/* 340*/298,113,299,123,298,130,295,133,286,134,272,135,268,135,242,138,225,143,211,149,202,155,189,167,179,179,171,191,167,199+1,0,0,
//];[
/* 350*/377,85,376,88,376,88,375,99,376,100,376,103,377,110,380,116,383,120,388,123,418,126,425,126,452,128,462,130,475,134,484,139,494,146,505,156,511,164,520,172,530,182,540,190,547,199+1,0,0,
/* 360*/472,199+1,470,196,459,187,451,180,442,173,430,165,429,166,429,171,428,178,424,185,417,192,407,199+1,0,0,

//服
/* 370*/256,136,248,144,236,154,227,157,215,164,202,170,195,177,195,180,198,186,206,193,215,199+1,0,0,
...
// 髪陰
/* 490*/229,23,220,21,210,20,198,22,184,29,178,34,179,36,185,32,187,32,182,42,178,40,175,46,174,53,179,65,187,73,199,80,218,86,215,83,202,76,198,71,190,61,184,50,185,47,193,55,194,54,193,37,199,32,206,26,222,22,0,0,
...
/* 530*/306,7,347,8,360,10,380,17,389,23,392,23,389,18,391,17,405,22,415,27,418,28,424,32,433,41,440,52,448,64,455,81,456,93,453,96,450,90,446,93,445,100,439,96,437,105,428,102,422,114,426,119,435,116,440,120,455,112,456,121,453,128,0,0,
/* 540*/320,10,330,10,344,13,0,0,
...
/* 590*/251,72,247,72,246,73,246,73,246,75,247,76,247,77,251,81,258,84,262,84,264,82,264,79,260,74,0,0,
/* 600*/251,72,251,74,250,75,248,75,250,75,251,76,251,77,254,80,257,81,259,81,260,80,260,79,256,75,253,74,251,74,0,0,
...
/* 640*/339,59,337,59,336,60,335,60,334,61,333,66,334,67,334,68,336,70,338,72,340,72,341,73,345,73,346,72,348,72,349,71,350,68,349,65,347,62,0,0,
/* 650*/337,60,339,61,339,62,337,64,335-1,64,338,64,338,66,342,70,344,70,345,69,345,68,344,65,343,64,342,63,339,63,0,0,
...
/* 880*/238,53,255,58,268+3,59,0,0,
//];[
/* 890*/299,58,306,60,0,0,
/* 900*/349,77-1,362,82,363,89,355,101,344,114,350,123,370,130,389,133,0,0,
/* 910*/391,133,405,134,0,0,
/* 920*/407,134,434,133,454+4,130,0,0,
/* 930*/423,160,425,159,430,154,444,157,459,170,488,199+1,0,0,
/* 940*/373+2,137,367-1,139+1,0,0,
/* 950*/365,142-1,373,151,0,0,
/* 960*/194,180,182,199+1,0,0,
/* 970*/374,153,373+2,160,0,0,
/* 980*/224,74,229,79,246,86,0,0,
/* 990*/265,80,267,82,267,85+1,0,0,
/*1000*/307,66-1,308,70,314,75,320,78,0,0,
/*1010*/353,65-1,353,71,351,74+1,0,0,
...
/*1090*/[[M]],[0,M,G,C],								//境界色潰しのための紫塗り
/*1100*/224,48,238,45,290,50,330,54,336,55,343,57,360,110,420,130,390,65, 430,162,370,144,379,156,414,166, 200,199-1,329,11,370,24,400,35,408,48,410,60,398,62,410,65,275,91,-1,-1,
...
//
/*1150*/[	[WYYY]],[0,G,C,Y,W,WWY],	//肌影
/*1160*/224,48,238,45,290,50,330,54,336,55,343,57,360,110,410,130,390,65,430,162,370,144,200,199-1,275,91,-1,-1,
...
/*1330*/[[WRRR]],[0],		// 背景
/*1340*/639,0,123,175,430,199-1,999,999,
];
